...
@section('title', 'Fulfillment Register')
    ...
    <div class="col-md-12">
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fas fa-archive"></i> Master Fulfillment Register (Historical)</h3>
                <div class="box-tools pull-right">
                    <span class="label label-success">Fulfilled Office Requests</span>
                </div>
            </div>
                              ...
                              <td>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('gov.requests.fulfillment_register.show', $req->id) }}" class="btn btn-sm btn-default">
                                        <i class="fas fa-search"></i> View Ledger Details
                                    </a>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5" class="text-center text-muted" style="padding: 20px;">No historically fulfilled requests found for your office location.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
