                        ...
                        <div class="product-info" style="margin-left: 0;">
                            ...
                            <span class="product-title text-blue" style="font-size: 16px;">
                                ...
                                @if($code->order_pdf_path)
                                    <a href="{{ route('gov.tracking.tracking-codes.download', $code->id) }}" class="label label-info pull-right"><i class="fa fa-download"></i> View PDF</a>
                                @endif
                            </span>
                            ...
                            <span class="product-description" style="margin-top: 5px; color: #555;">
                                ...
                                Fund: <strong>{{ $code->fund_main }}</strong> {{ $code->fund_sub ? '('.$code->fund_sub.')' : '' }} | 
                                Scope: Inherits Umbrella (Default) <!-- Overrides come in Phase 3 -->
                            </span>
