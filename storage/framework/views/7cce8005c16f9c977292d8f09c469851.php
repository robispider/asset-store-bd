...
$(document).ready(function() {
    ...
    if ($('.sidebar-menu').length) {
        ...
        <?php if($isAdmin || $isIctOfficer || $isOfficeAdmin): ?>
            ...
            <?php if($isAdmin || $isIctOfficer): ?>
                orgMenu += '<li class="' + (isRegistryActive ? 'active' : '') + '"><a href="<?php echo e(route("gov.org.provisioning.index")); ?>"><i class="fas fa-building fa-fw"></i> Office Registry</a></li>';
            <?php endif; ?>
            
            // 2. ICT Jurisdictions (Only for global Superadmins)
            <?php if($isAdmin): ?>
                orgMenu += '<li class="' + (isJurisdictionsActive ? 'active' : '') + '"><a href="<?php echo e(route("gov.org.jurisdictions.index")); ?>"><i class="fas fa-shield-alt fa-fw"></i> ICT Jurisdictions</a></li>';
            <?php endif; ?>

            // 3. Local Office Settings Checklist (For local Office Admins and Superadmins)
            <?php if($isAdmin || $isOfficeAdmin): ?>
                orgMenu += '<li class="' + (isOfficeSetupActive ? 'active' : '') + '"><a href="<?php echo e(route("gov.org.config.index")); ?>"><i class="fas fa-hotel fa-fw"></i> My Office Setup</a></li>';
            <?php endif; ?>
...
</script><?php /**PATH D:\git repo\asset-store-bd\packages\gov-store\organization\src\Providers/../resources/views/hooks/menu-injection.blade.php ENDPATH**/ ?>